 ...
 */
final class Version20240323164954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cities DROP state_code, DROP state_name, DROP country_name');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cities ADD state_code VARCHAR(4) NOT NULL, ADD state_name VARCHAR(100) NOT NULL, ADD country_name VARCHAR(100) NOT NULL');
